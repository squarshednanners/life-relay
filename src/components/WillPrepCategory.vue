...
const headerClass = computed(() => {
  switch (props.category.priority) {
    ...
    default: return 'bg-gray-50 dark:bg-gray-800/50 hover:bg-gray-100 dark:hover:bg-gray-700/50'
  }
})
...
const contentBorderClass = computed(() => {
  switch (props.category.priority) {
    ...
    default: return 'border-gray-200 dark:border-gray-700 bg-gray-50/30 dark:bg-gray-800/30'
  }
})
