<template>
  <div class="min-h-screen bg-gray-50">
    <!-- Hero Section -->
    <div class="relative overflow-hidden bg-gradient-to-br from-primary-700 via-primary-800 to-gray-900">
      <div class="absolute inset-0 opacity-10">
        <div class="absolute top-20 left-10 w-72 h-72 bg-white rounded-full blur-3xl" />
        <div class="absolute bottom-10 right-20 w-96 h-96 bg-primary-400 rounded-full blur-3xl" />
      </div>
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20 sm:pt-24 sm:pb-28">
        <div class="text-center">
          <div class="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-1.5 mb-6">
            ...
            <span class="text-sm text-white/90">100% offline &middot; Zero data collection</span>
          </div>
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <router-link
              to="/dashboard"
              class="px-8 py-4 bg-white text-primary-700 rounded-xl hover:bg-gray-100 transition-all text-lg font-semibold shadow-xl shadow-black/20"
            >
              Get Started
            </router-link>
            <a
              href="#features"
              class="px-8 py-4 bg-white/10 backdrop-blur-sm text-white border border-white/30 rounded-xl hover:bg-white/20 transition-all text-lg font-semibold"
            >
              Learn More
            </a>
          </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div class="text-center mb-10">
        <h2 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
          Your In-Case-of-Death Folder, Done Right
        </h2>
        <p class="text-gray-500 max-w-xl mx-auto">
          Whether you're preparing a will, documenting crypto for your heirs, or building a family emergency binder — Life Relay organizes it all in one place.
        </p>
      </div>
      <div class="grid sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
        <div class="bg-white rounded-xl border border-gray-200 p-6 text-center hover:shadow-md transition-shadow">
          <div class="text-3xl mb-3 text-orange-500 font-bold">
            &#x20BF;
          </div>
          ...
          <p class="text-sm text-gray-500">
            Create a crypto recovery plan — document wallets, seed phrase locations, exchange access, and multi-sig configurations so heirs can actually recover your assets.
          </p>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 p-6 text-center hover:shadow-md transition-shadow">
          ...
          <p class="text-sm text-gray-500">
            Build a family emergency binder with accounts, insurance, legal documents, final wishes, guardianship, and beneficiary designations — all in one organized place.
          </p>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 p-6 text-center hover:shadow-md transition-shadow">
          <div class="text-3xl mb-3">
          ...
          <p class="text-sm text-gray-500">
            Organize your information before meeting with an attorney. The Estate Planning Guide generates an Attorney Preparation Summary PDF you can bring to your first meeting.
          </p>
        </div>
      </div>
    </div>
    ...
    >
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
          ...
          <p class="text-gray-500 max-w-xl mx-auto">
            A free, comprehensive toolkit for legacy planning, inheritance preparation, and documenting where everything is — without uploading your data to anyone's server.
          </p>
        </div>

        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div class="group rounded-xl border border-gray-200 p-6 hover:border-primary-300 hover:shadow-md transition-all">
            <div class="w-10 h-10 bg-primary-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-primary-200 transition-colors">
              <svg
            ...
            <p class="text-sm text-gray-500 leading-relaxed">
              All data stored locally in your browser. No servers, no cloud, no tracking. AES-256 encrypted exports for secure backups.
            </p>
          </div>
          ...
          <div class="group rounded-xl border border-gray-200 p-6 hover:border-primary-300 hover:shadow-md transition-all">
            ...
            <p class="text-sm text-gray-500 leading-relaxed">
              Installable as a Progressive Web App. No internet required after first load. Your data is always accessible.
            </p>
          </div>
          ...
          <div class="group rounded-xl border border-gray-200 p-6 hover:border-primary-300 hover:shadow-md transition-all">
            ...
            <h3 class="font-semibold text-gray-900 mb-2">
              Emergency Sheet &amp; Wallet Cards
            </h3>
            <p class="text-sm text-gray-500 leading-relaxed">
              Generate a one-page emergency sheet with key contacts, medical info, and document locations — plus a printable sheet of credit-card-sized cards to carry in a wallet or glovebox.
            </p>
          </div>
          ...
          <div class="group rounded-xl border border-gray-200 p-6 hover:border-primary-300 hover:shadow-md transition-all">
            <div class="w-10 h-10 bg-amber-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-amber-200 transition-colors">
              ...
              >
                <path
                  ...
                  stroke-linejoin="round"
                  stroke-width="2"
                  d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l3 9a5.002 5.002 0 01-6.001 0M18 7l-3 9m-5.444-8.97A13.041 13.041 0 0112 5c1.268 0 2.39.232 3.444.654M3.859 12.5h0M20.141 12.5h0"
                />
              </svg>
            </div>
            <h3 class="font-semibold text-gray-900 mb-2">
            ...
            <p class="text-sm text-gray-500 leading-relaxed">
              Prepare for attorney meetings with a guided checklist covering wills, trusts, and estate plans. Generates an Attorney Preparation Summary PDF.
            </p>
          </div>
          ...
          <div class="group rounded-xl border border-gray-200 p-6 hover:border-primary-300 hover:shadow-md transition-all">
            ...
            <p class="text-sm text-gray-500 leading-relaxed">
              Document wallets, exchanges, seed phrase locations, multi-sig setups, and hardware devices. Build a complete crypto inheritance plan with step-by-step recovery instructions for heirs.
            </p>
          </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div class="text-center mb-10">
        <h2 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">
          36 Sections Across 8 Categories
        </h2>
        <p class="text-gray-500 max-w-xl mx-auto">
          From bank accounts to burial preferences — organized logically so you can fill in what matters and skip the rest.
        </p>
      </div>

      <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div
          v-for="group in sectionHighlights"
          :key="group.name"
          class="bg-white rounded-lg border border-gray-200 p-4"
        >
          <h4 class="font-semibold text-gray-900 mb-1.5 text-sm">
            {{ group.name }}
          </h4>
    ...
    <div class="bg-white py-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
          ...
          <p class="text-gray-500 max-w-xl mx-auto">
            No sign-up. No account. Just open and start.
          </p>
        </div>
        ...
        <div class="grid md:grid-cols-4 gap-8 max-w-5xl mx-auto">
          <div class="text-center">
            ...
            <p class="text-sm text-gray-500">
              Start fresh or import a previously exported vault. No sign-up — your data stays on your device.
            </p>
          </div>
          <div class="text-center">
            <div class="w-12 h-12 bg-primary-600 text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-3">
            ...
            <p class="text-sm text-gray-500">
              Navigate through organized sections. Skip what's not relevant. Everything saves automatically.
            </p>
          </div>
          <div class="text-center">
            <div class="w-12 h-12 bg-primary-600 text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-3">
            ...
            <p class="text-sm text-gray-500">
              Generate PDFs — full vault, emergency sheet, wallet cards, attorney prep summary, or family runbook. Export encrypted Life Relay file backups.
            </p>
          </div>
          <div class="text-center">
            <div class="w-12 h-12 bg-primary-600 text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-3">
            ...
            <p class="text-sm text-gray-500">
              The dashboard tracks your progress and reminds you to review every 90 days.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
          ...
          <p class="text-gray-400 max-w-xl mx-auto">
            Life Relay was designed from day one so your sensitive information never touches a server.
          </p>
        </div>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
          <div>
            ...
            <p class="text-sm text-gray-400">
              IndexedDB in your browser. Nothing sent to any server, ever.
            </p>
          </div>
          <div>
            <div class="text-2xl mb-2">
            ...
            <p class="text-sm text-gray-400">
              AES-256 password encryption for Life Relay file backups. Your data, your password.
            </p>
          </div>
          <div>
            <div class="text-2xl mb-2">
            ...
            <p class="text-sm text-gray-400">
              No sign-up, no email, no personal information collected. Just open and use.
            </p>
          </div>
          <div>
            <div class="text-2xl mb-2">
            ...
            <p class="text-sm text-gray-400">
              Install on your device like a native app. Works fully offline after first load.
            </p>
          </div>
        </div>
      </div>
    ...
    <!-- CTA Section -->
    <div class="bg-primary-600 text-white py-14">
      <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <router-link
          to="/dashboard"
          class="inline-block px-8 py-4 bg-white text-primary-700 rounded-xl hover:bg-gray-100 transition-all text-lg font-semibold shadow-xl shadow-black/10"
        >
          Get Started Now
        </router-link>
      </div>
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row items-start md:items-center gap-8">
          <div class="flex-shrink-0">
            ...
            <p class="text-sm text-gray-400">
              Like the project?<br>Consider a donation.
            </p>
          </div>
          ...
          <div class="flex flex-col gap-3 sm:ml-4">
            ...
            >
              <svg
                ...
                fill="currentColor"
                viewBox="0 0 24 24"
              ><path d="M19.885 3.398c.66 1.09.957 2.214.957 3.635 0 4.527-3.862 10.41-6.994 14.55H7.27L4.116 3.81l5.89-.561 1.76 14.12c1.627-2.652 3.636-6.825 3.636-9.674 0-1.353-.23-2.28-.627-3.033l5.11-1.264z" /></svg>
              Venmo
            </a>
            <a
    ...
    <footer class="bg-gray-800 text-gray-400 py-8">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-sm">
          Version 2.0.0 &middot; All data stored locally &middot; No tracking &middot; No servers
        </p>
