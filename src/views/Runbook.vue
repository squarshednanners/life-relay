<template>
  <div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 rounded-lg p-5">
      <h3 class="text-base font-semibold text-primary-900 dark:text-primary-200 mb-2">
      ...
      <ol class="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        >
          ...
          <div class="flex-1 min-w-0">
            ...
            <div
              v-if="step.references && step.references.length"
    ...
    <div class="bg-amber-50 dark:bg-amber-900/20 border border-amber-300 dark:border-amber-700 rounded-lg p-6">
      <h2 class="text-lg font-bold text-amber-900 dark:text-amber-200 mb-3">
        Important Don'ts
      </h2>
      <ul class="space-y-2.5">
        <li
          v-for="(item, idx) in donts"
          :key="idx"
          class="flex gap-3 text-sm text-amber-800 dark:text-amber-200 leading-relaxed"
        >
    ...
    >
      ...
      <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">
        Pulled from your Important Contacts. Call these people first.
      </p>
      <div class="grid sm:grid-cols-2 gap-3">
        <div
          v-for="(contact, idx) in quickContacts"
          :key="idx"
        ...
        >
          ...
          <div
            v-if="contact.phone"
            class="text-xs text-gray-700 dark:text-gray-300 mt-1"
          >
            {{ contact.phone }}
          </div>
        </div>
