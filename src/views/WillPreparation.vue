<template>
  <div class="max-w-4xl mx-auto space-y-6">
    <div>
      <h1 class="text-2xl font-bold text-gray-900">Estate Planning Guide</h1>
    ...
    <div class="bg-white border border-gray-200 rounded-lg p-4">
      <div class="flex items-center justify-between mb-2">
        <span class="text-sm font-medium text-gray-700">Overall Readiness</span>
    ...
    <div class="bg-white border border-gray-200 rounded-lg p-6">
      <h2 class="text-lg font-semibold text-gray-900 mb-4">Attorney Meeting Checklist</h2>
      <div class="space-y-4">
        <div v-for="group in attorneyMeetingChecklist" :key="group.category">
          <h3 class="text-sm font-semibold text-gray-700 mb-2">{{ group.category }}</h3>
    ...
    <!-- Generate PDF -->
    <div class="bg-white border border-gray-200 rounded-lg p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
      <div>
        <h2 class="text-lg font-semibold text-gray-900">Attorney Preparation Summary</h2>
